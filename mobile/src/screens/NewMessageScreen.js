...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.card, margin: 15, paddingHorizontal: 15, borderRadius: 10, elevation: 2 },
  ...
  selectedLabel: { fontSize: 14, color: theme.subText },
  ...
  userItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.card, padding: 15, borderRadius: 15, marginBottom: 10, elevation: 2 },
  ...
  userInfo: { flex: 1 },
  userName: { fontSize: 16, fontWeight: 'bold', color: theme.text, marginBottom: 2 },
  userBio: { fontSize: 12, color: '#999' },
  emptyContainer: { alignItems: 'center', paddingVertical: 60 },
  emptyTitle: { fontSize: 18, fontWeight: 'bold', color: theme.text, marginTop: 15, marginBottom: 8 },
  emptyText: { fontSize: 14, color: '#999', textAlign: 'center' },
  messageContainer: { flexDirection: 'row', alignItems: 'flex-end', padding: 15, backgroundColor: theme.card, borderTopWidth: 1, borderTopColor: '#e0e0e0', gap: 10 },
