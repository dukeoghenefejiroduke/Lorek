...
// APIs
import { adminAPI, vocabularyAPI, lessonAPI, cultureAPI } from '../services/api';
...
const AdminScreen = ({ navigation }) => {
  ...
  // ... inside handleCreateContent, add language to payloads:
  // e.g. for vocabulary: lang: selectedLanguage

  // ... Update Render UI:
  <View style={styles.pickerContainer}>
    <Text style={styles.pickerLabel}>Post In Language:</Text>
    <Picker 
...
const handlePublish = async (id) => {
 ...
 const onRefresh = async () => {
  ...
  try {
    ...
    if (global.apiUtils) global.apiUtils.clearCache(); 
