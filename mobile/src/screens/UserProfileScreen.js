  ...
  try {
    ...
    if (response.data.success) {
      navigation.replace('ChatDetail', {
        ...
        otherUser: profile, // Pass the whole profile object for better data handling
      });
    }
  } catch (error) {
      ...
      >
        ...
        {stats && (
          <View style={styles.statsGrid}>
            <StatCard icon="stars" label="Total Points" value={stats.totalPoints || 0} color="#FFD700" />
            <StatCard icon="whatshot" label="Day Streak" value={stats.streak || 0} color="#FF6B6B" />
            <StatCard icon="school" label="Words Learned" value={stats.wordsLearned || 0} color="#4CAF50" />
            <StatCard icon="menu-book" label="Lessons" value={stats.lessonsCompleted || 0} color="#2196F3" />
          </View>
        )}
        ...
        {stats && (
          <View style={styles.levelCard}>
            <View style={styles.levelHeader}>
              ...
              <Text style={styles.levelPoints}>{stats.totalPoints || 0} / {(stats.level || 1) * 100} XP</Text>
            </View>
        ...
        {badges.length > 0 && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionCount}>{badges.length} total</Text>
            </View>
