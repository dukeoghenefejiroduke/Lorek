    ...
    <View style={styles.container}>
      ...
      >
        <FlatList
          ...
          ListHeaderComponent={
            <Animated.View style={[styles.discussionCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
              {/* Pinned Badge */}
              {discussion.pinned && (
              ...
              <View style={styles.authorSection}>
                ...
                <View style={styles.authorInfo}>
                  <Text style={styles.authorName}>{discussion.author?.username}</Text>
              ...
              <View style={styles.discussionStats}>
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statText}>{discussion.replyCount || 0} replies</Text>
                </View>
                <View style={styles.statItem}>
                  <MaterialIcons name="visibility" size={18} color="#666" />
                  <Text style={styles.statText}>{discussion.views || 0} views</Text>
                </View>
              </View>
            </Animated.View>
          }
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <TouchableOpacity style={styles.modalOption} onPress={handleShare}>
                ...
                <Text style={styles.modalOptionText}>Share Discussion</Text>
              </TouchableOpacity>
      ...
      >
        <BlurView intensity={90} style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <Text style={styles.reportLabel}>Why are you reporting this discussion?</Text>
              <TextInput
