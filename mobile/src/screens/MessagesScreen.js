...
const styles = StyleSheet.create({
  ...
  conversationName: { fontSize: 16, fontWeight: 'bold', color: theme.text },
  conversationTime: { fontSize: 11, color: '#999' },
  conversationLastMessage: { fontSize: 13, color: theme.subText },
  unreadText: { fontWeight: 'bold', color: '#1a4c2e' },
  unreadCountBadge: {
    backgroundColor: '#4CAF50',
    minWidth: 22,
    height: 22,
  ...
  emptyTitle: { fontSize: 20, fontWeight: 'bold', color: theme.text, marginTop: 15, marginBottom: 8 },
