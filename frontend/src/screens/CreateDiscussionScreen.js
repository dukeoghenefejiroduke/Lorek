          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.titleContainer}>
                <TextInput
                  style={[styles.titleInput, { backgroundColor: theme.card }]}
            ...
            <View style={styles.section}>
              ...
              <TextInput
                style={[styles.contentInput, { backgroundColor: theme.card }]}
            ...
            <View style={[styles.tipsCard, { backgroundColor: theme.card }]}>
              <View style={styles.tipsHeader}>
                ...
                <Text style={[styles.tipsTitle, { color: theme.text }]}>Tips for a great discussion</Text>
              </View>
              <View style={styles.tipItem}>
                <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
                <Text style={[styles.tipText, { color: theme.subText }]}>Use a clear, descriptive title</Text>
              </View>
              <View style={styles.tipItem}>
                <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
                <Text style={[styles.tipText, { color: theme.subText }]}>Provide context and specific details</Text>
              </View>
              <View style={styles.tipItem}>
                <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
                <Text style={[styles.tipText, { color: theme.subText }]}>Be respectful and constructive</Text>
              </View>
              <View style={styles.tipItem}>
                <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
                <Text style={[styles.tipText, { color: theme.subText }]}>Use examples to illustrate your points</Text>
              </View>
            </View>
