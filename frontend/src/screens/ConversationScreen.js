...
const ConversationScreen = ({ route }) => {
      ...
      >
        ...
        >
          <View style={[
            ...
            !isUser && { backgroundColor: theme.card }
          ]}>
            {item.image && (
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {/* Vocabulary Panel */}
      {showVocab && (
        <Animated.View style={[styles.vocabPanel, { opacity: fadeAnim, backgroundColor: theme.card }]}>
          ...
          {scenario.vocabulary.map((item, index) => (
            <View key={index} style={styles.vocabItem}>
              <Text style={[styles.vocabWord, { color: theme.text }]}>{item.word}</Text>
              <Text style={[styles.vocabMeaning, { color: theme.subText }]}> - {item.meaning}</Text>
            </View>
          ))}
        </Animated.View>
      )}
